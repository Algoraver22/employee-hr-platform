...
const Sidebar = ({ collapsed, currentPage, onNavigate, onToggle, pageLoading }) => {
    ...
    return (
        <div className={`sidebar ${collapsed ? 'collapsed' : ''}`}>
            <div className="sidebar-header" style={{ userSelect: 'none', WebkitUserSelect: 'none', MozUserSelect: 'none', msUserSelect: 'none' }}>
                <div className="sidebar-logo" style={{animation: 'rotate 6s linear infinite', color: '#3b82f6', fontSize: '28px'}}>
                    🏢
                </div>
                {!collapsed && <h2 className="sidebar-title" style={{color: '#000000', userSelect: 'none', WebkitUserSelect: 'none', MozUserSelect: 'none', msUserSelect: 'none'}}>HR Platform</h2>}
            </div>
